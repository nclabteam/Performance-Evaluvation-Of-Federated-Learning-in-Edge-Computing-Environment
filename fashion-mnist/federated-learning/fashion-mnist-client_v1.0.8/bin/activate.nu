...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/edge1/tensorflow_fashion_mnist/fashion-mnist'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/edge1/tensorflow_fashion_mnist/fashion-mnist/bin/deactivate.nu'
