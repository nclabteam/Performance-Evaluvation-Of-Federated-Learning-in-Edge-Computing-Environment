...
def load_data(
    ...
    if (data_type == "2class-non-IID"):
        ...
        if (client_id%2 != 0): #Odd clients
           ...
           x_train_1st_class =  x_train_1st_class[:3000] 
           y_train_1st_class =  y_train_1st_class[:3000] 
           ...
           x_train_2nd_class = x_train_2nd_class[:3000]
           y_train_2nd_class = y_train_2nd_class[:3000]
           ...
           x_train = np.concatenate((x_train_1st_class,x_train_2nd_class))	
           y_train = np.concatenate((y_train_1st_class,y_train_2nd_class))
    if (data_type == "10class-non-IID"):
    	#10-class non-IID data
    	print("#########10 CLASS NON-IID DATA DISTRIBUTION###########") 
    	...
    	if (client_id == 1):
    	    x_train_0 = x_train_0[:600]
    	    y_train_0 = y_train_0[:600]
    	if (client_id == 2):
    	    x_train_1 = x_train_1[:600]
    	    y_train_1 = y_train_1[:600] 
    	if (client_id == 3):
    	    x_train_2 = x_train_2[:600]
    	    y_train_2 = y_train_2[:600]
    	if (client_id == 4):
    	    x_train_3 = x_train_3[:600]
    	    y_train_3 = y_train_3[:600] 
    	if (client_id == 5):
    	    x_train_4 = x_train_4[:600]
    	    y_train_4 = y_train_4[:600]
    	if (client_id == 6):
    	    x_train_5 = x_train_5[:600]
    	    y_train_5 = y_train_5[:600] 
    	if (client_id == 7):
    	    x_train_6 = x_train_6[:600]
    	    y_train_6 = y_train_6[:600]
    	if (client_id == 8):
    	    x_train_7 = x_train_7[:600]
    	    y_train_7 = y_train_7[:600]  
    	if (client_id == 9):
    	    x_train_8 = x_train_8[:600]
    	    y_train_8 = y_train_8[:600]
    	if (client_id == 10):
    	    x_train_9 = x_train_9[:600]
    	    y_train_9 = y_train_9[:600]      	
    	# Take a subset
    	x_train = np.concatenate((x_train_0, x_train_1,x_train_2,x_train_3,x_train_4,x_train_5,x_train_6,x_train_7,x_train_8,x_train_9))
    	y_train = np.concatenate((y_train_0, y_train_1,y_train_2,y_train_3,y_train_4,y_train_5,y_train_6,y_train_7,y_train_8,y_train_9))
    print("Label: ", y_train)
