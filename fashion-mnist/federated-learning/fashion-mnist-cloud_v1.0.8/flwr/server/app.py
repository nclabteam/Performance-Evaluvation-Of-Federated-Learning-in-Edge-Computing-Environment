...
def _fl(
    ...
    log(INFO, "app_fit: SUMMARY LOSS from cloud: %s", str(tuple(hist.losses_centralized)))
    log(INFO, "app_fit: SUMMARY ACCURACY from cloud: %s", str(tuple(hist.metrics_centralized)))
