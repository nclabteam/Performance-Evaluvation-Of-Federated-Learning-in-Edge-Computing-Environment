...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/cloud/tensorflow_fashion_mnist_virt_env/fashion-mnist'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/cloud/tensorflow_fashion_mnist_virt_env/fashion-mnist/bin/deactivate.nu'
